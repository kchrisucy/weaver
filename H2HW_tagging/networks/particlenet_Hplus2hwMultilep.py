...
class ParticleNetTagger1Path(nn.Module):
    ...
    def __init__(self,
                 ...
                 conv_params=[(4, (8, 8, 8)), (4, (16, 16, 16)), (4, (32, 32, 32))],
                 #fc_params=[(128, 0.1)],
                 fc_params=[(32, 0.1)],
                 use_fusion=True,
                 use_fts_bn=True,
        ...
        self.pf_conv = FeatureConv(pf_features_dims, 4)
        #self.pn = ParticleNet(input_dims=32,
        self.pn = ParticleNet(input_dims=4,
...
def get_model(data_config, **kwargs):
    ...
    ec_k = kwargs.get('ec_k', 4)
    #ec_c1 = kwargs.get('ec_c1', 64)
    ec_c1 = kwargs.get('ec_c1', 8)
    #ec_c2 = kwargs.get('ec_c2', 128)
    ec_c2 = kwargs.get('ec_c2', 16)
    #ec_c3 = kwargs.get('ec_c3', 256)
    ec_c3 = kwargs.get('ec_c3', 32)
